# From http://meta.stackoverflow.com/a/28231
#
# Usage (in the folder where you extracted the archive of the dump)
# python ../SO_dump_to_SQLite.py
# The SQLite database(s) will be written in the same folder
