...
/**
 * Created by arnaud on 17/04/14.
 */
/*
 * PlainDatabaseHelper is the object representation of the sample database and its tables
 */
public class PlainDatabaseHelper extends SQLiteOpenHelper {
     ...
     * @param dbName
     */
    public PlainDatabaseHelper(Context context, String dbName) {
    ...
    public void openDatabase() throws SQLException {
        ...
        //Open the database
        String myPath = DATABASE_PATH + DATABASE_NAME;
        sampleDatabase = SQLiteDatabase.openDatabase(myPath, null, SQLiteDatabase.OPEN_READONLY);
